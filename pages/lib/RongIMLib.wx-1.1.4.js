...
(function (global, factory) {
   ...
   * 公共部分
   */
  var getMini = (function (global) {
    var request = global.request;
    var storage = {
      set: global.setStorageSync,
      get: global.getStorageSync,
      remove: global.removeStorageSync,
      getKeys: function getKeys() {
        var res = global.getStorageInfoSync();
        return res.keys;
      }
    };
    var socket = {
      connectSocket: global.connectSocket,
      onSocketOpen: global.onSocketOpen,
      onSocketError: global.onSocketError,
      onSocketClose: global.onSocketClose,
      onSocketMessage: global.onSocketMessage,
      sendSocketMessage: global.sendSocketMessage,
      closeSocket: global.closeSocket
    };
    return {
      request: request,
      storage: storage,
  ...
  var RongLib = (function (mini) {
      var OriginJSON = JSON;

      return function () {
          var JSON = {
              stringify: OriginJSON.stringify,
              parse: function parse(str) {
                  var result = null;
                  try {
                      result = OriginJSON.parse(str);
                  } catch (e) {}
                  return result;
              }
          };

          //  WebSDK 内容开始的标识, 方便小程序 SDK 定位
          var Polling = {
              ...
              RtcQueryListInput: function RtcQueryListInput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              RtcKeyDeleteInput: function RtcKeyDeleteInput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              RtcValueInfo: function RtcValueInfo() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              //     var a = {};
              // },
              RtcUserListOutput: function RtcUserListOutput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              RtcRoomInfoOutput: function RtcRoomInfoOutput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              //     var a = {};
              // },
              RtcQryOutput: function RtcQryOutput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              //     var a = {};
              // },
              RtcDataInput: function RtcDataInput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              RtcSetDataInput: function RtcSetDataInput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              RtcTokenOutput: function RtcTokenOutput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              ChrmNotifyMsg: function ChrmNotifyMsg() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              ChrmKVEntity: function ChrmKVEntity() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              ChrmKVOutput: function ChrmKVOutput() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              QueryChrmKV: function QueryChrmKV() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
              ...
              DeleteChrmKV: function DeleteChrmKV() {
                  var a = {};
                  this.toArrayBuffer = function () {
                      return a;
                  };
          ...
          (function (RongIMLib) {
              var RongIMClient = function () {
                  ...
                  RongIMClient.init = function (appKey, dataAccessProvider, options, callback) {
                      ...
                      var protocol = "http://",
                          wsScheme = 'ws://';
                      var isLocationInvalid = (typeof location === "undefined" ? "undefined" : _typeof(location)) !== 'object'; // 未找到全局 location 变量, 则协议为 https. 比如小程序
                      ...
                      var isIntegrity = function isIntegrity() {
                          //iOS 9 
                          var hasWS = typeof WebSocket === "undefined" ? "undefined" : _typeof(WebSocket);
                          var integrity = typeof WebSocket.OPEN == 'number';
                          return hasWS && integrity;
                      };
                      if ((typeof WebSocket === "undefined" ? "undefined" : _typeof(WebSocket)) == 'object' && isIntegrity()) {
                          isPolling = false;
                      }
                      ...
                      var handler = function handler(message, uris, callback) {
                      ...
                      var RTCMessage = {
                          RTCPublishResourceMessage: function RTCPublishResourceMessage(message, uris) {
                              var userId = message.senderUserId;
                          ...
                          RTCUnpublishResourceMessage: function RTCUnpublishResourceMessage(message, uris) {
                              handler(message, uris, function (_uri, uri, _uris, index) {
                                  _uris.splice(index, 1);
                              });
                          },
                          RTCModifyResourceMessage: function RTCModifyResourceMessage(message, uris) {
                              handler(message, uris, function (_uri, uri) {
                                  _uri.state = uri.state;
                              });
                          },
                          RTCUserChangeMessage: function RTCUserChangeMessage(message) {
                  ...
                  */
                  ...
                  RongIMClient.prototype.subscribePublicService = function (publicServiceType, publicServiceId, callback) {
                      if (RongIMClient._memoryStore.depend.openMp) {
                          ...
                          var modules = new RongIMClient.Protobuf.MPFollowInput(),
                              me = this,
          ...
          (function (RongIMLib) {
              ...
              var _topic = ["invtDiz", "crDiz", "qnUrl", "userInf", "dizInf", "userInf", "joinGrp", "quitDiz", "exitGrp", "evctDiz", ["", "ppMsgP", "pdMsgP", "pgMsgP", "chatMsg", "pcMsgP", "", "pmcMsgN", "pmpMsgN", "", "", "", "prMsgS", "prMsgP"], "pdOpen", "rename", "uGcmpr", "qnTkn", "destroyChrm", "createChrm", "exitChrm", "queryChrm", "joinChrm", "pGrps", "addBlack", "rmBlack", "getBlack", "blackStat", "addRelation", "qryRelation", "delRelation", "pullMp", "schMp", "qnTkn", "qnUrl", "qryVoipK", "delMsg", "qryCHMsg", "getUserStatus", "setUserStatus", "subUserStatus", "cleanHisMsg"];
              var Channel = function () {
                  function Channel(cb, self) {
                      ...
                      var hasEvent = (typeof StatusEvent === "undefined" ? "undefined" : _typeof(StatusEvent)) == "object";
                      var me = this;
              ...
              var Bridge = function () {
                  ...
                  Bridge.prototype.setListener = function () {
                      ...
                      Channel._ReceiveMessageListener = {
                          onReceived: function onReceived(msg, count, hasMore) {
              ...
              var MessageHandler = function () {
                  ...
                  MessageHandler.prototype.onReceived = function (msg, pubAckItem, offlineMsg, leftCount, isSync) {
                      ...
                      if (isPersited) {
                          ...
                          RongIMLib.RongIMClient._dataAccessProvider.addConversation(con, { onSuccess: function onSuccess(data) {
                                  if (!offlineMsg) {
                      ...
                      if (message.conversationType == RongIMLib.ConversationType.CUSTOMER_SERVICE && (message.messageType == "ChangeModeResponseMessage" || message.messageType == "SuspendMessage" || message.messageType == "HandShakeResponseMessage" || message.messageType == "TerminateMessage" || message.messageType == "CustomerStatusUpdateMessage" || message.messageType == "TextMessage" || message.messageType == "InformationNotificationMessage")) {
                      ...
                      if (status == 0) {
                          ...
                          if (this._client.reconnectObj.onSuccess) {
                              ...
                              isNotifyConversationList && RongIMLib.RongIMClient._dataAccessProvider.getRemoteConversationList({
                                  onSuccess: function onSuccess(conversationList) {
                                      var Conversation = RongIMLib.RongIMClient._dataAccessProvider.Conversation;
                                      Conversation._notify(conversationList);
                                  },
                                  onError: function onError(code) {
          ...
          (function (RongIMLib) {
              var Navigation = function () {
                  ...
                  Navigation.prototype.request = function (navi, appId, token, _success, _error) {
          ...
          (function (RongIMLib) {
              ...
              var ChrmKVCaches = function () {
                  ...
                  ChrmKVCaches.prototype.setValue = function (kvContent) {
                      var key = kvContent.key,
                          timestamp = kvContent.timestamp;
              ...
              var getKVCache = function getKVCache(chrmId) {
              ...
              var getKVProsumer = function getKVProsumer(chrmId) {
              ...
              var ChrmKVHandler = function () {
                  ...
                  ChrmKVHandler.setEntries = function (chrmId, entity) {
                      var entries = entity.entries,
                          isFullUpdate = entity.bFullUpdate,
                  ...
                  ChrmKVHandler.setIncreEntries = function (chrmId, entries) {
                      ...
                      var optEvent = function optEvent(entity, isOverwrite, eventName) {
                          var key = entity.key,
                              value = entity.value;
              ...
              var UnreadCountHandler = function () {
                  ...
                  UnreadCountHandler.getAll = function (types) {
                      var total = 0;
                      var selfId = RongIMLib.RongIMClient.getInstance().getCurrentUserId();
                      var setTotal = function setTotal(keyList) {
              ...
              var ServerDataProvider = function () {
                  function ServerDataProvider() {
                      ...
                      this.Conversation = {
                          ...
                          watch: function watch(_watcher) {
                              this.watcher.add(_watcher);
                              var conversationList = RongIMLib.RongIMClient._memoryStore.conversationList;
                              this.watcher.emit(conversationList);
                          },
                          unwatch: function unwatch(_watcher) {
                              this.watcher.remove(_watcher);
                          },
                          _notify: function _notify(conversationList) {
                              this.watcher.emit(conversationList);
                          }
                      };
                  }
                  ...
                  */
                  ...
                  ServerDataProvider.prototype.getRemoteConversationList = function (callback, conversationTypes, count) {
                      var modules = new RongIMLib.RongIMClient.Protobuf.RelationsInput(),
                          self = this;
                      modules.setType(1);
                  ...
                  ServerDataProvider.prototype.createDiscussion = function (name, userIdList, callback) {
                      var modules = new RongIMLib.RongIMClient.Protobuf.CreateDiscussionInput(),
                          self = this;
                  ...
                  ServerDataProvider.prototype.refreshChatroomEntry = function (chatroomId, chatroomEntry, chatroomEntryOpt, callback) {
                      ...
                      var key = chatroomEntry.key,
                          value = chatroomEntry.value || '',
                          extra = chatroomEntry.notificationExtra;
                  ...
                  */
                  ...
                  ServerDataProvider.prototype.getRemotePublicServiceList = function (callback, pullMessageTime) {
                      if (RongIMLib.RongIMClient._memoryStore.depend.openMp) {
                          var modules = new RongIMLib.RongIMClient.Protobuf.PullMpInput();
                          if (!pullMessageTime) {
                              modules.setTime(0);
                          } else {
          ...
          (function (RongIMLib) {
              var VCDataProvider = function () {
                  ...
                  VCDataProvider.prototype.sendMessage = function (conversationType, targetId, messageContent, sendCallback, mentiondMsg, pushText, appData, methodType, params) {
                      ...
                      var msg = me.addon.sendMessage(conversationType, targetId, RongIMLib.RongIMClient.MessageParams[messageContent.messageName].objectName, messageContent.encode(), pushText || "", appData || "", function (progress) {}, function (message, code) {
                  ...
                  VCDataProvider.prototype.getChatRoomInfo = function (chatRoomId, count, order, callback) {
                      ...
                      this.addon.getChatroomInfo(chatRoomId, count, order, function (ret, count) {
                          var list = ret ? JSON.parse(ret).list : [],
                              chatRoomInfo = { userInfos: [], userTotalNums: count };
                          if (list.length > 0) {
                              for (var i = 0, len = list.length; i < len; i++) {
                  ...
                  VCDataProvider.prototype.buildConversation = function (val) {
                      ...
                      var conver = new RongIMLib.Conversation(),
                          c = JSON.parse(val),
                          lastestMsg = c.lastestMsg ? this.buildMessage(c.lastestMsg) : {};
                  ...
                  VCDataProvider.prototype.getRTCData = function (roomId, keys, isInner, apiType, callback) {
                      var context = this;
                      var hanlders = {
                          room_inner: function room_inner(roomId, keys, success, error) {
                              context.addon.getRTCInnerData(roomId, RongIMLib.RTCAPIType.ROOM, keys, success, error);
                          },
                          room_outer: function room_outer(roomId, keys, success, error) {
                  ...
                  VCDataProvider.prototype.removeRTCData = function (roomId, keys, isInner, apiType, callback, message) {
                      var context = this;
                      var hanlders = {
                          room_inner: function room_inner(roomId, keys, name, content, success, error) {
                              context.addon.deleteRTCInnerData(roomId, RongIMLib.RTCAPIType.ROOM, keys, name, content, success, error);
                          },
                          room_outer: function room_outer(roomId, keys, name, content, success, error) {
                              context.addon.deleteRTCOuterData(roomId, RongIMLib.RTCAPIType.ROOM, keys, name, content, success, error);
                          },
                          user_inner: function user_inner(roomId, keys, name, content, success, error) {},
                          user_outer: function user_outer(roomId, keys, name, content, success, error) {}
                      };
                      var type = RongIMLib.RTCAPIType.PERSON == apiType ? 'user' : 'room';
                      var direction = isInner ? 'inner' : 'outer';
                      var tpl = '{type}_{direction}';
          ...
          (function (RongIMLib) {
              var UserDataProvider = function () {
                  ...
                  UserDataProvider.prototype.removeItem = function (key) {
                      ...
                      this.oPersist.save(this.opersistName);
                      var keyNames = this.getItem(this.keyManager),
                          keyNameArray = keyNames && keyNames.split(',') || [];
                  ...
                  UserDataProvider.prototype.getItemKey = function (composedStr) {
                      var item = null,
                          keyNames = this.getItem(this.keyManager),
                          keyNameArray = keyNames && keyNames.split(',') || [];
                      var _key = this.prefix + composedStr;
          ...
          (function (RongIMLib) {
              ...
              var CheckParam = function () {
                  ...
                  CheckParam.prototype.checkCookieDisable = function () {
                      ...
                      var arr = document.cookie.match(new RegExp("(^| )checkCookie=([^;]*)(;|$)")),
                          isDisable = false;
                      if (!arr) {
                          isDisable = true;
                      }
          ...
          var miniRequest = mini.request,
              miniStorage = mini.storage,
              miniSocket = mini.socket;

          var tools = {
              request: function request(option, callbacks) {
                  var url = option.url;
                  ...
                  var xhr = miniRequest({
                      url: url, method: method, data: data, header: header,
              ...
              socket: function socket(option, callbacks) {
                  var url = option.url;
                  var method = option.method || 'get';
                  ...
                  miniSocket.onSocketOpen(function (res) {
                      callbacks.open(miniSocket, res);
                  });
                  miniSocket.onSocketError(callbacks.error);

                  miniSocket.onSocketMessage(callbacks.message);

                  miniSocket.onSocketClose(callbacks.close);

                  miniSocket.connectSocket({ url: url, data: data, method: method, header: header });
                  return miniSocket;
              }
          };

          var initIM = RongIMLib.RongIMClient.init;

          RongIMLib.RongIMClient.init = function (appKey, dataAccessProvider, options, callback) {
              options = options || {};
              options.isNotifyConversationList = true;
              return initIM(appKey, dataAccessProvider, options, callback);
          };

          /**
           * 重写 Comet 链接
          */
          var WebPollingTransportation = RongIMLib.PollingTransportation;

          var MiniPollingTransportation = function MiniPollingTransportation(params) {
              var me = new WebPollingTransportation(params);

              me.getRequest = function (url, isconnect, options) {
                  options = options || {};
                  ...
                  url = RongIMLib.RongUtil.tplEngine(tpl, {
                      protocol: protocol, url: url, pid: pid
                  });
              ...
              me.send = function (data) {
                  RongIMLib.RongIMClient._memoryStore.depend.wsScheme = 'wss://';
                  var path = data.url;
                  var servers = RongIMLib.RongIMClient._storageProvider.getItem('servers');
                  servers = JSON.parse(servers);
                  var host = servers[0]; // 在 requestNavi 处写死
                  var protocol = RongIMLib.RongIMClient._memoryStore.depend.protocol; // init 时判断
                  var pid = encodeURIComponent(me.pid);
                  var tpl = '{protocol}{host}/websocket{path}&pid={pid}';
                  var url = RongIMLib.RongUtil.tplEngine(tpl, { protocol: protocol, host: host, path: path, pid: pid });
                  ...
                  me.sendxhr = tools.request({
                      ...
                      success: function success(res) {
                          ...
                          if (isBadReq) {
                              // me.connected = false;
                              // me.onClose();
                              // me.socket.fire('StatusChanged', RongIMLib.ConnectionStatus.NETWORK_UNAVAILABLE);
                              console.log('inner sendmessage error', res);
                              return;
                          }
          ...
          RongIMLib.PollingTransportation = MiniPollingTransportation;

          /**
           * 重写 Socket 链接
          */
          var WebSocketTransportation = RongIMLib.SocketTransportation;

          var MiniSocketTransportation = function MiniSocketTransportation(params) {
              var me = new WebSocketTransportation(params);

              me.createTransport = function (url) {
                  url = 'wss://' + url;
                  var callbacks = {
                      open: function open() {
                          me.connected = true;
                          me.isClose = false;
                          me.socket.fire('connect');
                      },
                      error: function error() {
                          me.onError();
                      },
                  ...
                  me.socket = tools.socket(option, callbacks);
                  return me.socket;
              };

              me.disconnect = function (status) {
                  me.isClose = true;
                  if (status) {
                      me._status = status;
                  }
                  me.socket.closeSocket();
              };

              return me;
          };

          RongIMLib.SocketTransportation = MiniSocketTransportation;

          var LocalStorageProvider = function LocalStorageProvider() {
              var LocalStorageProviderPrefix = 'rong_';

              var setItem = function setItem(composedKey, object) {
                  var prefix = LocalStorageProviderPrefix;
                  if (composedKey) {
                      composedKey.indexOf(prefix) == -1 && (composedKey = prefix + composedKey);
                      miniStorage.set(composedKey, object);
                  }
              };

              var getItem = function getItem(composedKey) {
                  var prefix = LocalStorageProviderPrefix;
                  if (composedKey) {
                      composedKey.indexOf(prefix) == -1 && (composedKey = prefix + composedKey);
                      return miniStorage.get(composedKey);
                  }
                  return '';
              };

              var getItemKey = function getItemKey(composedStr) {
                  var prefix = LocalStorageProviderPrefix;
                  if (composedStr.indexOf(prefix) == -1) {
                      composedStr = prefix + composedStr;
                  }
                  var item = '';
                  var keys = miniStorage.getKeys();
              ...
              var getItemKeyList = function getItemKeyList(composedStr) {
                  var prefix = LocalStorageProviderPrefix;
                  if (composedStr.indexOf(prefix) == -1) {
                      composedStr = prefix + composedStr;
                  }
              ...
              var removeItem = function removeItem(composedKey) {
                  var prefix = LocalStorageProviderPrefix;
                  if (composedKey) {
                      composedKey.indexOf(prefix) == -1 && (composedKey = prefix + composedKey);
                      miniStorage.remove(composedKey);
                  }
              };
          ...
          RongIMLib.Navigation.prototype.requestNavi = function (token, appId, onSuccess) {
              var depend = RongIMLib.RongIMClient._memoryStore.depend;
              // 写死在此处
              var cometList = depend.cometList || ['cometproxy-cn.ronghub.com', 'mini-cn.ronghub.com'];
              var wsList = depend.wsList || ['wsproxy.cn.ronghub.com'];
              var isPolling = depend.isPolling;

              var server = isPolling ? cometList : wsList;
              RongIMLib.RongIMClient._storageProvider.setItem('servers', JSON.stringify(server));
              RongIMLib.RongIMClient._memoryStore.depend.protocol = depend.protocol || 'https://';
              RongIMLib.RongIMClient._memoryStore.depend.wsScheme = depend.wsScheme || 'wss://';
              onSuccess();
          };

          RongIMLib.RongUtil.supportLocalStorage = function () {
              return true;
          };

          RongIMLib.RongUtil.isSupportRequestHeaders = function () {
              return true;
          };

          RongIMLib.RongUtil.request = function (opts) {
              opts = opts || {};
              var success = opts.success;
              var error = opts.error;
              opts.method = opts.method || 'GET';
              return tools.request(opts, {
                  success: success,
                  fail: error
              });
          };

          RongIMLib.FeaturePatcher.prototype.patchJSON = function () {};
